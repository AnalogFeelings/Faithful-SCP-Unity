...
[ExecuteInEditMode]
public class CustomCubemap : MonoBehaviour
{
    public enum Kind
    {
        Sphere,
    ...
    public ReflectionProbe cube;

    public void OnEnable()
    {
        CustomCubemapEngine.instance.Add(this);
        cube = GetComponent<ReflectionProbe>();
    }
    ...
    {
        CustomCubemapEngine.instance.Remove(this);
    }
