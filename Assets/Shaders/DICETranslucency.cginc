...
half4 CalculateLight(unity_v2f_deferred i)
{
	...
	half3 specColor = lerp(unity_ColorSpaceDielectricSpec.rgb, baseColor, gbuffer1.r);//half3(gbuffer1.r, lerp(gbuffer1.g, gbuffer1.r, translucent), lerp(gbuffer1.b, gbuffer1.r, translucent));
	//specColor = half3(gbuffer1.r, lerp(gbuffer1.g, gbuffer1.r, translucent), lerp(gbuffer1.b, gbuffer1.r, translucent));
